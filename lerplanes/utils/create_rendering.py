...
def generate_pointclouds(rgb_np, depth_np, crop_left_size=0, depth_filter=None, vis_rgbd=False):
    ...
    # print('rgb_np: ',o3d.geometry.Image(check_image_type(rgb_np)))
    depth_np=depth_np.numpy()
    # print('depth_np: ',o3d.geometry.Image(depth_np))
...
def render_to_path_with_pointcloud(trainer: VideoTrainer, extra_name: str = "", save_pc_num: int = -1) -> None:
    ...
    for idx in save_pc_num:
        ...
        os.makedirs(os.path.join(trainer.log_dir, 'point_cloud'), exist_ok=True)
        o3d.io.write_point_cloud(os.path.join(
            trainer.log_dir, "point_cloud", f"pcd_{idx}.ply"), pcd)
